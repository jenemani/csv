...
const tableResult1 =
  "<table><tr><td>1</td><td>Providence</td><td>RI</td></tr><tr><td>2</td><td>Boston</td><td>MA</td></tr><tr><td>3</td><td>Dallas</td><td>TX</td></tr><tr><td>4</td><td>Los Angeles</td><td>CA</td></tr><tr><td>5</td><td>San Francisco</td><td>CA</td></tr></table>";
const tableResult2 =
  "<table><tr><th>id</th><th>city</th><th>state</th></tr><tr><td>1</td><td>Providence</td><td>RI</td></tr><tr><td>2</td><td>Boston</td><td>MA</td></tr><tr><td>3</td><td>Dallas</td><td>TX</td></tr><tr><td>4</td><td>Los Angeles</td><td>CA</td></tr><tr><td>5</td><td>San Francisco</td><td>CA</td></tr></table>";
const searchResult =
  "<table><tr><td>4</td><td>Los Angeles</td><td>CA</td></tr><tr><td>5</td><td>San Francisco</td><td>CA</td></tr></table>";
...
test("toggleMode", () => {
 ...
 expect(main.toggleMode(["mode"])).toBe(`Mode switched to ${main.briefMode? '"Brief"': '"Verbose"'}`);
 ...
 */
const startingHTML = `<div class="repl">
...
test("switching modes", () => {
  ...
  expect(output).toHaveTextContent(
    `Command: mode Output: Mode switched to "Verbose" Command: view Output: No file loaded`
  );
  ...
  expect(output).toHaveTextContent(
    `Mode switched to "Verbose" No file loaded Mode switched to "Brief"`
  );
...
test("Load File", () => {
  ...
  expect(output).toHaveTextContent(
    `Loaded data/noHeaderData.csv as a CSV file with no header`
  );
});
...
test("Load another file", function () {
  ...
  expect(output).toHaveTextContent(
    "please provide column index for file without header"
  );
  userEvent.type(input, "search 1 Boston");
  userEvent.click(submit);
